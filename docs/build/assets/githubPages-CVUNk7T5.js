import{jsx as n,jsxs as i,Fragment as p}from"react/jsx-runtime";import{e as c}from"./vendor-CuygkBdc.js";import"react";const u={title:"GitHub Pages"},g="GitHub Pages{% note info flat %}在部署项目前，您需确保有远程仓库，满足上述条件后即可使用命令将项目部署到远程仓库。{% endnote %}部署命令是通过 GitHub Actions 部署 GitHub Pages。首先，如果仓库以 username.github.",b=[{id:"github-pages",text:"GitHub Pages",depth:1}];function s(o){const e={a:"a",br:"br",code:"code",div:"div",h1:"h1",p:"p",span:"span",...c(),...o.components},{CodeBlock:r,Icon:t}=e;return r||a("CodeBlock"),t||a("Icon"),i(p,{children:[i(e.h1,{id:"github-pages",children:[n(e.a,{className:"header-anchor",href:"#github-pages",children:n(e.span,{className:"icon icon-link"})}),"GitHub Pages"]}),`
...
最后可前往 username.github.io/repository 查看网页。`]})]})}function m(o={}){const{wrapper:e}={...c(),...o.components};return e?n(e,{...o,children:n(s,{...o})}):s(o)}function a(o,e){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default,u as frontmatter,g as mdInfo,b as toc};
