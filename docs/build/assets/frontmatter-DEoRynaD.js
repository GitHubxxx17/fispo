import{jsx as e,jsxs as n,Fragment as c}from"react/jsx-runtime";import{e as i}from"./vendor-CuygkBdc.js";import"react";const s={title:"frontmatter",date:"2025-03-31 16:44:55",updated:"2025-05-27 17:53:07",info:"frontmatterFront-matter 是文件开头的 YAML 代码块，用于配置写作设置。 以 YAML 格式书写时，Front-matter 以三个破折号结束：---title: Hello Worlddate: 2025/4/1 20:46:25---配置属性名描述title文章的标题d"},m=[{id:"frontmatter",text:"frontmatter",depth:1},{id:"配置",text:"配置",depth:2}];function d(r){const t={a:"a",br:"br",h1:"h1",h2:"h2",p:"p",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...i(),...r.components},{CodeBlock:l}=t;return l||function(){throw new Error("Expected component `CodeBlock` to be defined: you likely forgot to import, pass, or provide it.")}(),n(c,{children:[n(t.h1,{id:"frontmatter",children:[e(t.a,{className:"header-anchor",href:"#frontmatter",children:e(t.span,{className:"icon icon-link"})}),"frontmatter"]}),`
