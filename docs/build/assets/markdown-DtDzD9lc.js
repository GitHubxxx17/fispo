...
`]})]}),`
`]})]})}function N(a={}){const{wrapper:n}={...d(),...a.components};return n?e(n,{...a,children:e(l,{...a})}):l(a)}function t(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{N as default,m as frontmatter,f as toc};
