...
var lazy$2 = lazy;
lazy$2.lib = lazy$1;
const Route0 = loadable$2(() => __vitePreload(() => import("./helloworld-CYbR1iNR.js"), true ? [] : void 0));
const routes = [
  { path: "/post/helloworld", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./helloworld-CYbR1iNR.js"), true ? [] : void 0) }
];
const Content = () => {
  console.log(routes);
