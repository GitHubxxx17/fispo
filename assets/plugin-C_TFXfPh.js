import{jsx as r,jsxs as e,Fragment as s}from"react/jsx-runtime";import{e as t}from"./vendor-CuygkBdc.js";import"react";const p={title:"插件"},g="插件如果您想要自己开发插件，可通过 Fispo 的初始化工具创建插件项目的模板初始化项目create-fispo <项目目录名> --plugin文件结构初始化后，您的项目文件夹将如下所示：.├── fispo.config.ts          # 项目的配置文件├── package-lock",h=[{id:"插件",text:"插件",depth:1},{id:"初始化项目",text:"初始化项目",depth:2},{id:"文件结构",text:"文件结构",depth:2},{id:"开发插件",text:"开发插件",depth:2}];function i(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",span:"span",ul:"ul",...t(),...a.components},{CodeBlock:o}=n;return o||function(){throw new Error("Expected component `CodeBlock` to be defined: you likely forgot to import, pass, or provide it.")}(),e(s,{children:[e(n.h1,{id:"插件",children:[r(n.a,{className:"header-anchor",href:"#插件",children:r(n.span,{className:"icon icon-link"})}),"插件"]}),`
...
`,language:"ts"})]})}function m(a={}){const{wrapper:n}={...t(),...a.components};return n?r(n,{...a,children:r(i,{...a})}):i(a)}export{m as default,p as frontmatter,g as mdInfo,h as toc};
