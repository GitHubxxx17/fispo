...
function flattenRoutes(routes2, branches, parentsMeta, parentPath) {
  ...
  routes2.forEach((route, index) => {
    ...
    if (meta.relativePath.startsWith("/")) {
      !meta.relativePath.startsWith(parentPath) ? invariant$1() : void 0;
...
const Route0 = React3.lazy(() => __vitePreload(() => import("./index-DvHnTpYQ.js"), true ? [] : void 0));
const Route1 = React3.lazy(() => __vitePreload(() => import("./config-oMOdC31E.js"), true ? [] : void 0));
const Route2 = React3.lazy(() => __vitePreload(() => import("./setup-Bkfg3aWj.js"), true ? [] : void 0));
const Route3 = React3.lazy(() => __vitePreload(() => import("./index-Igr-Dh_8.js"), true ? [] : void 0));
const routes = [
  { path: "/guide/", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./index-DvHnTpYQ.js"), true ? [] : void 0) },
  { path: "/guide/introduction/config", element: React3.createElement(Route1), preload: () => __vitePreload(() => import("./config-oMOdC31E.js"), true ? [] : void 0) },
  { path: "/guide/introduction/setup", element: React3.createElement(Route2), preload: () => __vitePreload(() => import("./setup-Bkfg3aWj.js"), true ? [] : void 0) },
  { path: "/", element: React3.createElement(Route3), preload: () => __vitePreload(() => import("./index-Igr-Dh_8.js"), true ? [] : void 0) }
];
...
async function handleRoutes(routes2, postDir) {
  const articlesList = [];
  const tags = {};
  const categories = {};
  for await (const route of routes2) {
    const moduleInfo = await route.preload();
    if (!(moduleInfo == null ? void 0 : moduleInfo.frontmatter)) continue;
    ...
    moduleInfo.frontmatter.date = moduleInfo.frontmatter.date ?? (/* @__PURE__ */ new Date()).toLocaleString();
    articlesList.push({
...
const build = () => {
  const lookup = (reducer) => {
    return reduce(styles$4, (o$$1, style, prefix) => {
  ...
  const hasRegular = "far" in styles$4 || config.autoFetchSvg;
...
function applyShimAndAlias(skipLookups, givenPrefix, canonical) {
  ...
  if (prefix === "far" && !styles$4["far"] && styles$4["fas"] && !config.autoFetchSvg) {
    prefix = "fas";
  }
  return {
    prefix,
...
const GlobalComponents = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: globalComponents.map((globalComponent) => {
...
function Nav(props) {
  ...
  const resetMenus = reactExports.useCallback(() => {
  ...
  const clickToChangeTheme = reactExports.useCallback(() => {
    const classList2 = document.documentElement.classList;
    const theme = classList2.contains("dark") ? "light" : "dark";
    localSaveData(THEME, theme);
    classList2.toggle("dark");
    setCurTheme(theme);
  }, []);
  reactExports.useEffect(() => {
    const scroll = (_, isTop2) => {
      setIsTop(isTop2);
    };
  ...
  const renderTools = reactExports.useMemo(() => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5["nav-tools-item"], children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { title: "切换黑白主题", onClick: clickToChangeTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: curTheme === "light" ? "sun" : "moon" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5["nav-tools-item"], children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { title: "github", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "https://github.com/GitHubxxx17/fispo", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "github" }) }) }) })
    ] });
  }, [curTheme]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "nav",
      {
        className: classNames(styles$5.nav, {
          [styles$5["nav-top"]]: isTop
        }),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5["nav-left"], children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5["blog-name"], children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: "/", children: [
              logo && /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: logo }),
              title
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.menus, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: renderMenus }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5["nav-right"], children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5["nav-right-tools"], children: renderTools }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: styles$5["nav-right-menus"],
                onClick: () => {
                  setIsShowMenus((v) => {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "bars" })
              }
            )
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: classNames(styles$5["nav-menus"], {
          [styles$5["nav-menus-show"]]: isShowMenus
        }),
        children: [
          renderMenus,
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5["nav-menus-tools"], children: renderTools })
        ]
      }
    )
  ] });
...
function HomeLayout(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.homeLayout, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3["home-hero"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3["home-hero-left"], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3["home-hero-button"], children: frontmatter.buttons.map((button, key) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3["home-hero-right"], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3["home-hero-right-img-bg"] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: logo })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3["home-feature"], children: frontmatter.features.map((item, key) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3["home-feature-item"], children: [
...
const docLayout = "_docLayout_18wab_1";
const content = "_content_18wab_6";
const styles$2 = {
  docLayout,
  content
};
const sidebar = "_sidebar_m8fm3_1";
const sidebarTitle = "_sidebarTitle_m8fm3_8";
const sidebarContent = "_sidebarContent_m8fm3_11";
const sidebarItem = "_sidebarItem_m8fm3_14";
const active$1 = "_active_m8fm3_18";
const styles$1 = {
  sidebar,
  sidebarTitle,
  sidebarContent,
...
const SideBar = (props) => {
  ...
  const renderGroup = (item) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.sidebarTitle, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: item.text }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.sidebarContent, children: (_a2 = item.items) == null ? void 0 : _a2.map((item2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: classNames(styles$1.sidebarItem, {
            [styles$1.active]: pathname === item2.link
          }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: styles$1.sidebar, children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { children: sidebarData.map(renderGroup) }) });
};
const aside = "_aside_bg6lk_1";
const active = "_active_bg6lk_14";
const styles = {
  aside,
  active,
  "toc-item": "_toc-item_bg6lk_17"
};
const Aside = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.aside, children: [
...
const DocLayout = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.docLayout, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SideBar, { sidebarData: matchedSidebar, pathname: pagePath }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.content, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Content$1, {}) }),
...
async function initPageData(routePath) {
  ...
  const getPageData = (pageType, frontmatter, title, toc) => {
    return {
      pageType,
      siteData,
      frontmatter,
...
function App({
  ...
  reactExports.useEffect(() => {
    ...
    return () => {
      lifecycleList2.pageClosed.forEach(
        (fn) => executeFunctionFromString(fn, pageData)
      );
    };
  }, []);
...
async function renderInBrowser() {
  ...
  lifecycleList.configResolved.map(
    (fn) => executeFunctionFromString(fn, pageData)
  );
