...
const Route0 = React3.lazy(() => __vitePreload(() => import("./index-D9RURB0L.js"), true ? [] : void 0));
const Route1 = React3.lazy(() => __vitePreload(() => import("./helloworld-CEMLQZIy.js"), true ? [] : void 0));
const routes = [
  { path: "/", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./index-D9RURB0L.js"), true ? [] : void 0) },
  { path: "/post/helloworld", element: React3.createElement(Route1), preload: () => __vitePreload(() => import("./helloworld-CEMLQZIy.js"), true ? [] : void 0) }
];
const siteData = { "base": "/fispo", "title": "Fispo", "description": "专为构建现代化博客而设计的静态站点生成器", "theme": "theme-docs", "themeConfig": { "navMenus": [{ "title": "指南", "path": "/guide" }, { "title": "配置项", "path": "/config" }, { "title": "主题", "path": "/theme" }, { "title": "插件", "path": "/plugin" }], "banner": { "img": "/banner.png", "title": "", "subTitle": "" } }, "vite": { "base": "/fispo" }, "author": "XXX17", "avatar": "/avatar.jpg", "backgroundImg": "/bg.png", "root": "docs", "postDir": "/post", "build": "build", "public": "public", "notFoundImg": "/404.png", "logo": "/logo.png", "markdown": {}, "plugins": [], "preloader": false, "deploy": { "branch": "master", "repo": "" }, "htmlTags": [] };
