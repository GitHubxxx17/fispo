...
function flattenRoutes(routes2, branches, parentsMeta, parentPath) {
  ...
  routes2.forEach((route, index) => {
    ...
    if (meta2.relativePath.startsWith("/")) {
      !meta2.relativePath.startsWith(parentPath) ? invariant$2() : void 0;
    ...
    if (route.children && route.children.length > 0) {
      !(route.index !== true) ? invariant$2() : void 0;
...
function useLocation() {
  !useInRouterContext() ? invariant$2() : void 0;
...
const render3 = function(iconDefinition) {
  let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  const {
    transform = meaninglessTransform,
    symbol = false,
