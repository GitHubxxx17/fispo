...
const Route0 = React3.lazy(() => __vitePreload(() => import("./HTTP-arfJyYrk.js"), true ? [] : void 0));
const Route1 = React3.lazy(() => __vitePreload(() => import("./MySQL-C2khFagW.js"), true ? [] : void 0));
const Route2 = React3.lazy(() => __vitePreload(() => import("./node.js-B0n3--B2.js"), true ? [] : void 0));
const Route3 = React3.lazy(() => __vitePreload(() => import("./vue3笔记（四）-Dw4z3MIV.js"), true ? [] : void 0));
const Route4 = React3.lazy(() => __vitePreload(() => import("./vue笔记（一）-ho24Z6XR.js"), true ? [] : void 0));
const Route5 = React3.lazy(() => __vitePreload(() => import("./vue笔记（三）-fqgALUJR.js"), true ? [] : void 0));
const Route6 = React3.lazy(() => __vitePreload(() => import("./vue笔记（二）-DmVXShee.js"), true ? [] : void 0));
const Route7 = React3.lazy(() => __vitePreload(() => import("./搭建云服务器-D8vg8P4c.js"), true ? [] : void 0));
const Route8 = React3.lazy(() => __vitePreload(() => import("./数组sort()详解-Cy9u5zT7.js"), true ? [] : void 0));
const routes = [
  { path: "/post/HTTP", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./HTTP-arfJyYrk.js"), true ? [] : void 0) },
  { path: "/post/MySQL", element: React3.createElement(Route1), preload: () => __vitePreload(() => import("./MySQL-C2khFagW.js"), true ? [] : void 0) },
  { path: "/post/node", element: React3.createElement(Route2), preload: () => __vitePreload(() => import("./node.js-B0n3--B2.js"), true ? [] : void 0) },
  { path: "/post/vue3%E7%AC%94%E8%AE%B0%EF%BC%88%E5%9B%9B%EF%BC%89", element: React3.createElement(Route3), preload: () => __vitePreload(() => import("./vue3笔记（四）-Dw4z3MIV.js"), true ? [] : void 0) },
  { path: "/post/vue%E7%AC%94%E8%AE%B0%EF%BC%88%E4%B8%80%EF%BC%89", element: React3.createElement(Route4), preload: () => __vitePreload(() => import("./vue笔记（一）-ho24Z6XR.js"), true ? [] : void 0) },
  { path: "/post/vue%E7%AC%94%E8%AE%B0%EF%BC%88%E4%B8%89%EF%BC%89", element: React3.createElement(Route5), preload: () => __vitePreload(() => import("./vue笔记（三）-fqgALUJR.js"), true ? [] : void 0) },
  { path: "/post/vue%E7%AC%94%E8%AE%B0%EF%BC%88%E4%BA%8C%EF%BC%89", element: React3.createElement(Route6), preload: () => __vitePreload(() => import("./vue笔记（二）-DmVXShee.js"), true ? [] : void 0) },
  { path: "/post/%E6%90%AD%E5%BB%BA%E4%BA%91%E6%9C%8D%E5%8A%A1%E5%99%A8", element: React3.createElement(Route7), preload: () => __vitePreload(() => import("./搭建云服务器-D8vg8P4c.js"), true ? [] : void 0) },
  { path: "/post/%E6%95%B0%E7%BB%84sort()%E8%AF%A6%E8%A7%A3", element: React3.createElement(Route8), preload: () => __vitePreload(() => import("./数组sort()详解-Cy9u5zT7.js"), true ? [] : void 0) }
];
const siteData = { "title": "XXX17的个人博客", "description": "学无止境", "theme": "", "themeConfig": { "navMenus": [{ "title": "首页", "path": "/", "icon": "home" }, { "title": "标签", "path": "/tag", "icon": "tag" }, { "title": "分类", "path": "/category", "icon": "folder-open" }, { "title": "关于", "path": "/about", "icon": "heart" }], "banner": { "img": "/banner.png", "subtitle": "" }, "sidebar": { "enable": true, "hide": false, "position": "right", "card_author": { "enable": true, "description": "", "button": { "enable": true, "icon": "github", "text": "Follow me", "link": "" } }, "card_announcement": { "enable": true, "content": "" }, "card_recent_post": { "enable": true, "limit": 5, "sort": "date" }, "card_categories": { "enable": true, "limit": 10 }, "card_tags": { "enable": true, "limit": 10 }, "card_webinfo": { "enable": true, "post_count": true, "last_push_date": true, "run_time": true } }, "footer": { "message": "", "copyright": "" } }, "vite": {}, "author": "XXX17", "avatar": "/avatar.jpg", "backgroundImg": "/bg.png", "root": "docs", "postDir": "post", "public": "public", "notFoundImg": "/404.png", "logo": "/logo.png", "markdown": {}, "plugins": [], "preloader": true };
