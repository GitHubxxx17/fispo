...
var lazy$2 = lazy;
lazy$2.lib = lazy$1;
const Route0 = loadable$2(() => __vitePreload(() => import("./HTTP-SA6CnKDQ.js"), true ? [] : void 0));
const Route1 = loadable$2(() => __vitePreload(() => import("./MySQL-F9s8-P06.js"), true ? [] : void 0));
const Route2 = loadable$2(() => __vitePreload(() => import("./node.js-SIZOWQnP.js"), true ? [] : void 0));
const Route3 = loadable$2(() => __vitePreload(() => import("./vue3笔记（四）-BG2DcCJX.js"), true ? [] : void 0));
const Route4 = loadable$2(() => __vitePreload(() => import("./vue笔记（一）-DI_z0Od3.js"), true ? [] : void 0));
const Route5 = loadable$2(() => __vitePreload(() => import("./vue笔记（三）-DCLKPzTJ.js"), true ? [] : void 0));
const Route6 = loadable$2(() => __vitePreload(() => import("./vue笔记（二）-B7Ed4a3r.js"), true ? [] : void 0));
const Route7 = loadable$2(() => __vitePreload(() => import("./搭建云服务器-C6w5WY2X.js"), true ? [] : void 0));
const Route8 = loadable$2(() => __vitePreload(() => import("./数组sort()详解-BGWse-yn.js"), true ? [] : void 0));
const routes = [
  { path: "/post/HTTP", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./HTTP-SA6CnKDQ.js"), true ? [] : void 0) },
  { path: "/post/MySQL", element: React3.createElement(Route1), preload: () => __vitePreload(() => import("./MySQL-F9s8-P06.js"), true ? [] : void 0) },
  { path: "/post/node", element: React3.createElement(Route2), preload: () => __vitePreload(() => import("./node.js-SIZOWQnP.js"), true ? [] : void 0) },
  { path: "/post/vue3笔记（四）", element: React3.createElement(Route3), preload: () => __vitePreload(() => import("./vue3笔记（四）-BG2DcCJX.js"), true ? [] : void 0) },
  { path: "/post/vue笔记（一）", element: React3.createElement(Route4), preload: () => __vitePreload(() => import("./vue笔记（一）-DI_z0Od3.js"), true ? [] : void 0) },
  { path: "/post/vue笔记（三）", element: React3.createElement(Route5), preload: () => __vitePreload(() => import("./vue笔记（三）-DCLKPzTJ.js"), true ? [] : void 0) },
  { path: "/post/vue笔记（二）", element: React3.createElement(Route6), preload: () => __vitePreload(() => import("./vue笔记（二）-B7Ed4a3r.js"), true ? [] : void 0) },
  { path: "/post/搭建云服务器", element: React3.createElement(Route7), preload: () => __vitePreload(() => import("./搭建云服务器-C6w5WY2X.js"), true ? [] : void 0) },
  { path: "/post/数组sort()详解", element: React3.createElement(Route8), preload: () => __vitePreload(() => import("./数组sort()详解-BGWse-yn.js"), true ? [] : void 0) }
];
const Content = () => {
  console.log(routes);
